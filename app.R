                ...
                dashboardBody(
                  tabItems(
                    tabItem(tabName = "1", # Home ----- 
                            ...
                            It has been made with", tags$a(href="https://shiny.rstudio.com/", "Shiny", target = "blank"), " and is accessible both", tags$a(href="https://github.com/Ilora2021/ILORA", "independently", target = "blank"), " and through the database",
